...
const PoliticalContributions = (props) => {
  ...
  useEffect(() => {
    if (deleteEmissionData.status === STATUS.SUCCESS) {
      enqueueSnackbar("Political Contributions deleted successfully", {
        variant: "success",
      });
  ...
  const onUpdatePurchasedElectricity = () => {
    navigate(`/emissions/edit/political_contributions/${emissionId}`);
  };
