...
const AntiCorruptionTraining = (props) => {
  ...
  useEffect(() => {
    if (deleteEmissionData.status === STATUS.SUCCESS) {
      enqueueSnackbar("Anti Corruption Training deleted successfully", {
        variant: "success",
      });
  ...
  const onUpdatePurchasedElectricity = () => {
    navigate(`/emissions/edit/anti_corruption_training/${emissionId}`);
  };
