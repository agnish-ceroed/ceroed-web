...
const AgeBasedStatistics = (props) => {
  ...
  useEffect(() => {
    if (deleteEmissionData.status === STATUS.SUCCESS) {
      enqueueSnackbar("Age Based Statistics deleted successfully", {
        variant: "success",
      });
  ...
  const onUpdatePurchasedElectricity = () => {
    navigate(`/emissions/edit/age_based_statistics/${emissionId}`);
  };
...
export default AgeBasedStatistics;
