...
const GenderBasedStatistics = (props) => {
  ...
  useEffect(() => {
    if (deleteEmissionData.status === STATUS.SUCCESS) {
      enqueueSnackbar("Gender Based Statistics deleted successfully", {
        variant: "success",
      });
  ...
  const onUpdatePurchasedElectricity = () => {
    navigate(`/emissions/edit/gender_based_statistics/${emissionId}`);
  };
...
export default GenderBasedStatistics;
