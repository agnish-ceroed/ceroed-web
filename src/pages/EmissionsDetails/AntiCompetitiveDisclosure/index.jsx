...
const AntiCompetitiveDisclosure = (props) => {
  ...
  useEffect(() => {
    if (deleteEmissionData.status === STATUS.SUCCESS) {
      enqueueSnackbar("Anti Competitive Disclosure deleted successfully", {
        variant: "success",
      });
  ...
  const onUpdatePurchasedElectricity = () => {
    navigate(`/emissions/edit/anti_competitive_disclosure/${emissionId}`);
  };
        ...
        <Box className={classes.topContainer}>
          ...
          >
            <Grid item container direction={"column"} xs={10}>
              ...
              <Typography className={classes.previewItem}>
                Affected Party: {emissionData.affected_party}
              </Typography>
              <Typography className={classes.previewItem}>
                Corrective Action: {emissionData.corrective_action}
              </Typography>
              <Typography className={classes.previewItem}>
...
export default AntiCompetitiveDisclosure;
