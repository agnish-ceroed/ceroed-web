...
const DevelopmentAndTraining = (props) => {
  ...
  useEffect(() => {
    if (deleteEmissionData.status === STATUS.SUCCESS) {
      enqueueSnackbar("Development and Training data deleted successfully", {
        variant: "success",
      });
  ...
  const onUpdatePurchasedElectricity = () => {
    navigate(`/emissions/edit/development_training/${emissionId}`);
  };
...
export default DevelopmentAndTraining;
