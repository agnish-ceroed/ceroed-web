...
import { addDescriminationIncidentRecord, resetAddCombustionStatus } from '../../../redux/actions';
...
const AddDescriminationIncidentForm = (props) => {
    ...
    useEffect(() => {
        if (addEmissionData.status === STATUS.SUCCESS) {
            enqueueSnackbar('Descrimination incident record added successfully', { variant: 'success' });
    ...
    return (
        <Container className={classes.container}>
            <Box className={classes.innerContainer}>
                <Typography className={classes.title} variant="h6" component="div" >Add Descrimination Incident Record</Typography>
