...
import { addAntiCorruptionTraining, resetAddCombustionStatus } from '../../../redux/actions';
import CeroButton from '../../../components/CeroButton';
import CeroInput from '../../../components/CeroInput';
import CeroEpochDatePicker from '../../../components/CeroDateTimePicker/CeroEpochDatePicker';
import useStyles from "./styles";

const AddAntiCorruptionTrainingForm = (props) => {
    const { onCancel } = props
    const dispatch = useDispatch();
    const classes = useStyles();
    const { enqueueSnackbar } = useSnackbar();

    const addEmissionData = useSelector(state => state.emission.addCorruptionTraining)
    ...
    useEffect(() => {
        if (addEmissionData.status === STATUS.SUCCESS) {
            enqueueSnackbar('Anti-corruption Training added successfully', { variant: 'success' });
    ...
    const onAddAntiCorruptionTraining = () => {
        const requestData = {
        ...
        dispatch(addAntiCorruptionTraining(requestData))
    };

    return (
        <Container className={classes.container}>
            <Box className={classes.innerContainer}>
                <Typography className={classes.title} variant="h6" component="div" >Add Anti-corruption Training</Typography>
            ...
            <Box className={classes.buttonContainer}>
                ...
                <CeroButton
                    ...
                    onClick={onAddAntiCorruptionTraining} />
            </Box>
        </Container >
    )
}

export default AddAntiCorruptionTrainingForm;
