...
import { addSupplierHumanRightsTraining, resetAddCombustionStatus } from '../../../redux/actions';
import CeroButton from '../../../components/CeroButton';
import CeroInput from '../../../components/CeroInput';
import CeroEpochDatePicker from '../../../components/CeroDateTimePicker/CeroEpochDatePicker';
import useStyles from "./styles";

const AddSupplierHumanRightsTrainingForm = (props) => {
    const { onCancel } = props
    const dispatch = useDispatch();
    const classes = useStyles();
    const { enqueueSnackbar } = useSnackbar();

    const addEmissionData = useSelector(state => state.emission.addSupplierHumanRightsTraining)
    ...
    const onAddSupplierHumanRightsTraining = () => {
        const requestData = {
        ...
        <Container className={classes.container}>
            ...
            <Box className={classes.buttonContainer}>
                ...
                <CeroButton
                    ...
                    onClick={onAddSupplierHumanRightsTraining} />
            </Box>
        </Container >
    )
}

export default AddSupplierHumanRightsTrainingForm;
