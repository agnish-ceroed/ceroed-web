...
import { addAntiCorruptionDisclosure, resetAddCombustionStatus } from '../../../redux/actions';
...
const AddAntiCorruptionDisclosureForm = (props) => {
    ...
    const addEmissionData = useSelector(state => state.emission.addCorruptionDisclosure)
    ...
    useEffect(() => {
        if (addEmissionData.status === STATUS.SUCCESS) {
            enqueueSnackbar('Anti-corruption Disclosure added successfully', { variant: 'success' });
    ...
    return (
        <Container className={classes.container}>
            <Box className={classes.innerContainer}>
                <Typography className={classes.title} variant="h6" component="div" >Add Anti-corruption Disclosure</Typography>
