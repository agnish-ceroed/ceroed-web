...
const API_BASE_URL = 'https://staging-ceroed-api.inventlabs.org';
...
export const APIEndpoints = {
  ...
  UPDATE_REFRIGERANTS: emissionId => `${API_BASE_URL}/business/emissions/refrigerants/${emissionId}`,
  ...
  EDIT_TRANSPORTATION_COMBUSTION: emissionId => `${API_BASE_URL}/business/emissions/transportation/${emissionId}`,
  ...
  UPDATE_WATER_CONSUMPTION_COMBUSTION: emissionId => `${API_BASE_URL}/business/emissions/water_consumption/${emissionId}`,
  UPDATE_WASTE_COMBUSTION: emissionId => `${API_BASE_URL}/business/emissions/waste/${emissionId}`,
